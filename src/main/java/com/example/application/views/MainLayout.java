 ...
 */
@PWA(name = "Vaadin Test", shortName = "Vaadin Test", enableInstallPrompt = false)
@Push
@Theme(themeFolder = "vaadintest")
public class MainLayout extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "Vaadin Test logo"));
        logoLayout.add(new H1("Vaadin Test"));
